...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    topics: ['Broca', 'Wernicke', 'aphasia', 'lateralization', 'critical period', '失語症', 'não bộ', 'neurolinguistics'],
    minutes: 30,
    status: 'outline',
  },
  {
    ...
    topics: ['morpheme', 'hình vị', 'từ láy', 'từ ghép', 'affix', 'derivation', 'inflection', '形態素', 'agglutinative'],
    minutes: 35,
    status: 'outline',
  },
  {
    ...
    topics: ['syntax', 'constituent', 'phrase structure', 'tree', 'SVO', 'SOV', 'head', 'recursion', '統語論', 'trợ từ'],
    minutes: 40,
    status: 'outline',
  },
  {
    ...
    topics: ['semantics', 'synonym', 'antonym', 'hyponymy', 'polysemy', 'homonym', 'metaphor', '意味論', 'trường nghĩa'],
    minutes: 35,
    status: 'outline',
  },
  {
    ...
    topics: ['pragmatics', 'deixis', 'speech act', 'implicature', 'Grice', 'politeness', '敬語', 'xưng hô', 'presupposition'],
    minutes: 35,
    status: 'outline',
  },
  {
    ...
    topics: ['phonetics', 'IPA', 'consonant', 'vowel', 'tone', 'thanh điệu', 'stress', 'pitch accent', '音声学', 'mora'],
    minutes: 40,
    status: 'outline',
  },
  {
    ...
    topics: ['phonology', 'phoneme', 'allophone', 'minimal pair', 'syllable', 'âm tiết', 'rendaku', '連濁', 'phonotactics'],
    minutes: 35,
    status: 'outline',
  },
  {
