...
export const lessons: Lesson[] = [
  {
    ...
    objectives: [
      ...
      'Nhận ra khoảng cách giữa ngữ pháp trong sách và ngôn ngữ thực tế khi học tiếng Anh, và giới hạn của tính võ đoán qua オノマトペ tiếng Nhật.',
    ],
    topics: ['tín hiệu', 'võ đoán', 'Saussure', 'Hockett', 'Chomsky', 'competence', 'performance', 'grammar', 'design features', '恣意性', 'オノマトペ', 'sound symbolism', 'ngôn ngữ ký hiệu', '手話'],
    minutes: 45,
    status: 'complete',
  },
  {
  ...
  },
  {
    ...
    objectives: [
      ...
      'Giải thích các hiện tượng xử lý ngôn ngữ: hiệu ứng tần suất, hiệu ứng mồi, câu lối vào vườn, nói nhịu.',
    ],
    topics: ['acquisition', 'babbling', 'L2', 'interlanguage', 'transfer', 'garden path', 'slip of the tongue', '言語習得', 'song ngữ', 'wug test', 'overgeneralization', 'priming', 'Hán Việt – âm On'],
    minutes: 60,
    status: 'complete',
  },
  {
    ...
    objectives: [
      ...
      'Phân tích ngôn ngữ và giới, kiêng kỵ – uyển ngữ và ngôn ngữ vai trò (役割語) trong ba ngôn ngữ.',
    ],
    topics: ['sociolinguistics', 'dialect', 'phương ngữ', 'register', 'code-switching', 'pidgin', 'creole', '方言', '関西弁', 'taboo', '役割語', 'World Englishes', 'kiêng húy', '若者言葉'],
    minutes: 60,
    status: 'complete',
  },
  {
    ...
    description:
      'Vì sao ngôn ngữ thay đổi, các kiểu biến đổi nghĩa, phương pháp so sánh – lịch sử, họ ngôn ngữ, nguồn gốc thanh điệu tiếng Việt, vay mượn và lớp từ Hán Việt – Kango.',
    objectives: [
      'Nêu các loại biến đổi: ngữ âm, hình thái, cú pháp, từ vựng, ngữ nghĩa (mở rộng, thu hẹp, tốt lên, xấu đi).',
      'Trình bày phương pháp so sánh – lịch sử, tương ứng âm (luật Grimm) và khái niệm ngôn ngữ tiền thân.',
      'Xác định họ ngôn ngữ của tiếng Việt, tiếng Anh, tiếng Nhật và giải thích quá trình hình thành thanh điệu tiếng Việt.',
      'Giải thích tác động của cuộc chinh phạt Norman và Đại chuyển dịch nguyên âm đối với tiếng Anh.',
      'Phân tích các lớp vay mượn: Hán Việt – cổ Hán Việt, ba lớp âm On, từ ngoại lai, sao phỏng và wasei-kango.',
    ],
    topics: ['language change', 'language family', 'proto-language', 'cognate', "Grimm's law", 'loanword', 'calque', 'Hán Việt', '漢語', '和製漢語', 'Great Vowel Shift', 'Haudricourt', 'thanh điệu', 'Norman', '呉音・漢音'],
    minutes: 60,
    status: 'complete',
  },
  {
